...
aws cloudformation create-stack --stack-name zcloud --template-body file://home/oskr_grme/.local/zcloud.cfn.yml --parameters ParameterKey=AMI,ParameterValue=$AMI ParameterKey=MYIP,ParameterValue=$MYIP
sleep 500
